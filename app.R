...
choices = c(
  ...
  "Nouns in the Ablative case" = "nouns_ablative",
  "Nouns in the Genitive case" = "nouns_genitive",
  "Nouns in the Locative case" = "nouns_locative",
  ...
  "Verbs in the informal Imperative mood" = "imperative_verbs_informal",
